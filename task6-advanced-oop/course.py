...
Lecture = Instructor("Aime", "UR2025", "Python ") 
course = Course("PY2002", "Python Programming", 3, Lecture) # create a course object
print(course) 

newcourse = Course.create_course("WEB002", "Web Development", 4, Lecture)

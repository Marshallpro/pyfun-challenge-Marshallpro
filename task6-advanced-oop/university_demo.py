...
def demo():
    ...
    instructor1 = Instructor("peter", "Prof20009", "Computer Engineering")
    ...
    course2 = Course.create_course("WEB021", "Web Development", 4, instructor1)
    ...
    print(f"Course information: \n Code: {course2.course_code}, Name: {course2.course_name}, Credits: {course2.credits}, Instructor: {course2.instructor.name}")  
     # Create students
    student1 = Student("Mary", "REG22489")
    student2 = Student("Eric", "REG22450")
    ...
    ta1 = TeachingAssistant("Dr Marshall", "REG2240071", "Lct001", "PYTHON")
